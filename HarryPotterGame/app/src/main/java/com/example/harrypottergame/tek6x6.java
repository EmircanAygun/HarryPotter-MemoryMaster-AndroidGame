...
public class tek6x6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tek6x6);
        ...
        if(ak2==0){music = MediaPlayer.create(tek6x6.this, R.raw.prologue);music.start();ak2=1;}
        ...
        new CountDownTimer(45000, 1000) {
            ...
            public void onFinish() {
                ...
                if(ak!=1){music3 = MediaPlayer.create(tek6x6.this, R.raw.shocked);music3.start();
                ...
                loop.removeAll(loop);
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(tek6x6.this);
                alertDialogBuilder
                        .setMessage("Bitti\n")
                        .setCancelable(false)
                        .setPositiveButton("new", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                Intent intent = new Intent(getApplicationContext(),tek6x6.class);
    ...
    private void hesaplama(){
        if(ilkKart == ikinciKart){
            ...
            //if(sira == 1){
            if(ak!=1){
                music2 = MediaPlayer.create(tek6x6.this, R.raw.victorytheme);
                music2.start();
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
    ...
    private void oyunSonuKontrolu(){
        if(iv_11.getVisibility()==View.INVISIBLE && iv_12.getVisibility()==View.INVISIBLE && iv_13.getVisibility()==View.INVISIBLE && iv_14.getVisibility()==View.INVISIBLE && iv_15.getVisibility()==View.INVISIBLE && iv_16.getVisibility()==View.INVISIBLE &&
            ...
            bitti=1;
            if(ak!=1){music4 = MediaPlayer.create(tek6x6.this, R.raw.congratulations);music4.start();
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        music4.stop();
    ...
    private void firebaseResimAl(int k){
        ...
        getImage.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled( @NonNull DatabaseError databaseError) {
                Toast.makeText(tek6x6.this, "Resim Yüklerken Sorun Oluştu", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void getdata(int kart) {
        ...
        databaseReference2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Toast.makeText(tek6x6.this,""+value,Toast.LENGTH_SHORT).show();
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(tek6x6.this, "Kart bilgisi alınamadı", Toast.LENGTH_SHORT).show();
                value = -1;
            }
