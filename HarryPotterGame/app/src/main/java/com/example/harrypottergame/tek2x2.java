...
public class tek2x2 extends AppCompatActivity {
    ...
    int value,k, katsayi,sure,bitti=0;
    int kart1,kart2,kartt,ak=0,ak2=0;
    ImageView acKapa;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tek2x2);
        ...
        if(ak2==0){music = MediaPlayer.create(tek2x2.this, R.raw.prologue);music.start();ak2=1;}
        ...
        new CountDownTimer(45000, 1000) {
            ...
            public void onFinish() {
                ...
                if(ak!=1){music3 = MediaPlayer.create(tek2x2.this, R.raw.shocked);music3.start();
                ...
                loop.removeAll(loop);
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(tek2x2.this);
                alertDialogBuilder
                        .setMessage("Bitti\n")
                        .setCancelable(false)
                        .setPositiveButton("new", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                Intent intent = new Intent(getApplicationContext(),tek2x2.class);
    ...
    private void hesaplama(){
        if(ilkKart == ikinciKart){
            ...
            //if(sira == 1){
            if(ak!=1){
                music2 = MediaPlayer.create(tek2x2.this, R.raw.victorytheme);
                music2.start();
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
            ...
            //if(sira ==1){
                ...
                if(k1==k2){
                    ...
                    oyuncu1 =( oyuncu1 - (int)hesap );// /((45-sure)/10)
    ...
    private void oyunSonuKontrolu(){
        if(iv_11.getVisibility()==View.INVISIBLE &&
            ...
            bitti=1;
            if(ak!=1){music4 = MediaPlayer.create(tek2x2.this, R.raw.congratulations);music4.start();
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        music4.stop();
    ...
    private void firebaseResimAl(int k){
        ...
        getImage.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled( @NonNull DatabaseError databaseError) {
                Toast.makeText(tek2x2.this, "Resim Yüklerken Sorun Oluştu", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void getdata(int kart) {
        ...
        databaseReference2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Toast.makeText(tek2x2.this,""+value,Toast.LENGTH_SHORT).show();
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(tek2x2.this, "Kart bilgisi alınamadı", Toast.LENGTH_SHORT).show();
                value = -1;
            }
